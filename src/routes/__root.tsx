...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mobile carts solutions for events and retail. Custom, portable display carts built to your brand." },
      { name: "author", content: "Rumicarts" },
      { property: "og:title", content: "Rumicarts — Mobile Cart Solutions for Events & Retail" },
      { property: "og:description", content: "Mobile carts solutions for events and retail." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@rumicarts" },
    ],
    links: [
      {
        rel: "stylesheet",
